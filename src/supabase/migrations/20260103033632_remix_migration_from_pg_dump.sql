...
--
-- Name: setup_admin_on_signup(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.setup_admin_on_signup() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
  -- Check if the new user's email is the designated admin email
  IF NEW.email = 'syswebcosmg@gmail.com' THEN
...
--
-- Name: facilities Admins can manage facilities; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can manage facilities" ON public.facilities USING (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "Admins can manage rooms" ON public.rooms USING (public.has_role(auth.uid(), 'admin'::public.app_role));
...
--
-- Name: facilities Anyone can view active facilities; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: reviews Anyone can view active reviews; Type: POLICY; Schema: public; Owner: -
--
